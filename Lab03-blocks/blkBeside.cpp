...
int blk::Beside::compute_height(blk::expr op1, blk::expr op2){
    return blk::Beside::compute_ref_height(op1, op2) + std::max(op1->get_height() - op1->get_ref_height(), op2->get_height() - op2->get_ref_height());
}
...
blk::Beside::Beside(blk::expr op1, blk::expr op2) 
                    :Block(blk::Beside::compute_width(op1, op2),
                    blk::Beside::compute_height(op1, op2),
                    blk::Beside::compute_ref_width(op1, op2),
                    blk::Beside::compute_ref_height(op1, op2)), op1(op1), op2(op2) {}
